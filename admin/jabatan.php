  ...
  if (isset($_GET['delete_id'])) {
    ...
    $sql_get_image = "SELECT gambar FROM jabatan WHERE id_jabatan = $delete_id";
    ...
    $sql_delete = "DELETE FROM jabatan WHERE id_jabatan = $delete_id";
...
<body>
  ...
  <main id="main" class="main">
    <table class="my-3 table table-bordered">
      <a href="jabatan_tambah.php" class="btn btn-primary" role="button"></i>Tambah</a>
      <thead>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="jabatan_edit.php?id_jabatan=<?php echo $data['id_jabatan']; ?>" class="btn btn-warning mb-2" role="button">Edit</a>
            <a href="jabatan.php?delete_id=<?php echo $data['id_jabatan']; ?>" class="btn btn-danger mb-2" role="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
          </td>
        </tr>
        <?php
          }
