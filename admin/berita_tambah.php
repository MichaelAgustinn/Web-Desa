...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $tanggal_upload_berita = input($_POST["tanggal_upload_berita"]);
  $judul_berita = input($_POST["judul_berita"]);
  $isi_berita = input($_POST["isi_berita"]);
  ...
  // Cek ukuran file
  if ($_FILES["image"]["size"] > 5000000) { // 500  0KB
  ...
  if ($_FILES["image"]["error"] !== UPLOAD_ERR_OK) {
    echo "<div class='alert alert-danger'>Terjadi kesalahan saat mengunggah file: " . $_FILES["image"]["error"] . "</div>";
  }
  ...
  $sql = "INSERT INTO berita (tanggal_upload_berita, judul_berita, isi_berita, gambar) VALUES
    ('$tanggal_upload_berita', '$judul_berita', '$isi_berita', '$gambar')";
  ...
  <main id="main" class="main">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="date" name="tanggal_upload_berita" class="form-control" required />
      </div>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="isi_berita" name="isi_berita" rows="4" placeholder="Masukkan isi berita"></textarea>
      </div>
