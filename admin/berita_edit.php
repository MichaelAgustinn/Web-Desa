<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE berita SET
      tanggal_upload_berita='$tanggal_upload_berita',
  ...
  <main id="main" class="main">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <input type="date" name="tanggal_upload_berita" class="form-control" value="<?php echo htmlspecialchars($data['tanggal_upload_berita']); ?>" required/>
      </div>
      <div class="form-group">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="isi_berita" name="isi_berita" rows="4"><?php echo htmlspecialchars($data['isi_berita']); ?></textarea>
      </div>

      <button type="submit" name="submit" class="btn btn-success mt-3">Save</button>
      <a href="berita.php" class="btn btn-danger mt-3">Cancel</a>
    </form>
  </main><!-- End #main -->
