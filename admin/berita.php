...
if (isset($_GET['delete_id'])) {
  ...
  $sql_get_image = "SELECT gambar FROM berita WHERE id_berita = $delete_id";
  ...
  $sql_delete = "DELETE FROM berita WHERE id_berita = $delete_id";
...
<body>
  ...
  <main id="main" class="main">
    <table class="my-3 table table-bordered">
      <a href="berita_tambah.php" class="btn btn-primary" role="button"></i>Tambah</a>
      <thead>
      ...
      <tbody>
        <tr>
          ...
          ?>
            <td><?php echo $no; ?></td>
            <td><img src="uploads/<?php echo htmlspecialchars($data['gambar']); ?>" max-width="200px" alt="Gambar Berita"></td>
            <td><?php echo $data["tanggal_upload_berita"]; ?></td>
            <td><?php echo $data["judul_berita"]; ?></td>
            <td><?php echo $data["isi_berita"]; ?></td>
            <td>
              <a href="berita_edit.php?id_berita=<?php echo $data['id_berita']; ?>" class="btn btn-warning mb-2" role="button">Edit</a>
              <a href="berita.php?delete_id=<?php echo $data['id_berita']; ?>" class="btn btn-danger mb-2" role="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
            </td>
        </tr>
      <?php
          }
