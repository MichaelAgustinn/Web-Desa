<?php
  ...
  if (isset($_GET['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM agenda WHERE id_agenda=$delete_id";
...
<body>
  ...
  <main id="main" class="main">
    <table class="my-3 table table-bordered">
      <a href="agenda_tambah.php" class="btn btn-primary" role="button"></i>Tambah</a>
      <thead>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="agenda_edit.php?id_agenda=<?php echo $data['id_agenda']; ?>" class="btn btn-warning mb-2" role="button">Edit</a>
            <a href="agenda.php?delete_id=<?php echo $data['id_agenda']; ?>" class="btn btn-danger mb-2" role="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
          </td>
        </tr>
        <?php
          }
