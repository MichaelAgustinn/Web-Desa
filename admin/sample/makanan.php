  ...
  <div class="container mt-5 pt-4">
    <?php
      ...
      if (isset($_GET['delete_id'])) {
        ...
        $sql_delete = "DELETE FROM menu WHERE id_menu=$delete_id";
    ...
    <table class="my-3 table table-bordered">
      ...
      <tbody>
        ...
        ?>
          ...
          <td>
            <a href="update2.php?id_menu=<?php echo $data['id_menu']; ?>" class="btn btn-warning" role="button">Update</a>
            <a href="makanan.php?delete_id=<?php echo $data['id_menu']; ?>" class="btn btn-danger" role="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
          </td>
        </tr>
        <?php
          }
