<?php
  ...
  if (isset($_GET['id_struktur'])) {
    $id_struktur = input($_GET["id_struktur"]);

    $sql = "SELECT * FROM struktur WHERE id_struktur = $id_struktur";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id_struktur = htmlspecialchars($_POST["id_struktur"]);
...
<head>
  ...
  <title>Admin - Edit Struktur Organisasi</title>
...
<body>
  ...
  <main id="main" class="main">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
      <input type="hidden" name="id_struktur" value="<?php echo $data['id_struktur']; ?>" />
      <div class="mb-3">
