<?php
  ...
  if (isset($_GET['delete_id'])) {
    ...
    $sql_get_image = "SELECT gambar FROM struktur WHERE id_struktur = $delete_id";
    ...
    $sql_delete = "DELETE FROM struktur WHERE id_struktur = $delete_id";
...
<body>
  ...
  <main id="main" class="main">
    <table class="my-3 table table-bordered">
      <!-- <a href="struktur_tambah.php" class="btn btn-primary" role="button"></i>Tambah</a> -->
      <thead>
      ...
      <tbody>
        <tr>
          <?php
            $sql="select * from struktur order by id_struktur desc";
            $hasil=mysqli_query($koneksi,$sql);
            $data = mysqli_fetch_array($hasil);
          ?>
          <td><img src="uploads/<?php echo htmlspecialchars($data['gambar']); ?>" max-width="200px" alt="Gambar"></td>
          <td>
            <a href="struktur_edit.php?id_struktur=<?php echo $data['id_struktur']; ?>" class="btn btn-warning mb-2" role="button">Edit</a>
          </td>
        </tr>
      </tbody>
    </table>
